...
import 'package:gcportfolio/utils/helper/common.dart';

class AnimatedTextBoxLoop extends StatefulWidget {
  const AnimatedTextBoxLoop({
    super.key,
    required this.text,
  ...
  @override
  State<AnimatedTextBoxLoop> createState() => _AnimatedTextBoxLoopState();
}

class _AnimatedTextBoxLoopState extends State<AnimatedTextBoxLoop>
